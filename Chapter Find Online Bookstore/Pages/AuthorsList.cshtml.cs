...
{
    public class AuthorsListModel : PageModel
    {
        private dbclass t1;
        ...
        private readonly ILogger<AuthorsListModel> _logger;

        public AuthorsListModel(ILogger<AuthorsListModel> logger, dbclass t1)
        {
            _logger = logger;
            this.t1 = t1;
        }
